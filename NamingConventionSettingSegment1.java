...
@Test
public class NamingConventionSettingSegment1 {
    ...
    public void customSettingInvite() throws InterruptedException, IOException {
        ...
        String baseSegmentName = "1212_Diva_12122027"; // Base name to start with
        String regexPattern = "\\d+_[A-Za-z]+_\\d{8}"; // Regular expression for the desired format

        String currentSegmentName = baseSegmentName;
        String middleChar = "X"; // Character to insert when a duplicate is found
        ...
        if (!currentSegmentName.matches(regexPattern)) {
            ...
            String[] parts = currentSegmentName.split("_");
            ...
            currentSegmentName = validNumber + "_" + validLetters + "_" + validDate;
        }
        ...
        while (true) {
            try {
                ...
                if (errorMessages.isEmpty()) {
                    ...
                    currentSegmentName = String.join("_", parts);
